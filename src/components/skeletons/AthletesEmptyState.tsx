...
export const AthletesEmptyState = ({ onReset }: AthletesEmptyStateProps) => {
  return (
    <div style={{
      display: 'flex',
      ...
      <p style={{
        ...
        No academy athletes match your search criteria or selected position/age group filters. Try resetting the filters.
      </p>
